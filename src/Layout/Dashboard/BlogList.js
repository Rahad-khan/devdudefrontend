                            ...
                            <tbody>
                                {
                                    blogs.map(blog => <tr key={blog._id}>
                                        ...
                                        <td className="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap space-x-2">
                                            ...
                                            <button type="button" className="inline-block px-4 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-red-700 hover:shadow-lg focus:bg-red-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 active:shadow-lg transition duration-150 ease-in-out">Delete</button>
